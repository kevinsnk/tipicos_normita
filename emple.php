...
<form role="form" method="post" id="agregar">
  <div class="form-group">
    ...
    <input type="text" onkeypress="soloLetras(event)" class="form-control" name="Nombres"  >
  </div>
  <div class="form-group">
    <label for="Apellidos">Apellidos</label>
    <input type="text" onkeypress="soloLetras(event)" class="form-control" name="Apellidos"  >
  </div>
  <div class="form-group">
    <label for="tipoEmp">Tipo de Empleado</label>
    <input type="text" class="form-control" name="tipoEmp" >
  </div>
   <div class="form-group">
    <label for="cargoEmp">Cargo</label>
    <input type="text" class="form-control" name="cargoEmp">
  </div>
   <div class="form-group">
