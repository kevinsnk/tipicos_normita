...
$user_id=null;
$sql1= "SELECT categoria.NOMBRE_CATEGORIA, productos.NOMBRE, productos.PRECIO, productos.DESCRIPCION, productos.ID_PRODUCTO FROM categoria INNER JOIN productos ON categoria.ID_CATEGORIA=productos.CATEGORIA ";
